...
##### 4.6.1.1. Predicción y evaluación para los datos de entrenamiento
...
##### 4.6.1.2. Predicción y Evaluación para los datos de Validación en el año 2018
...
##### 4.6.1.3. Predicción y Evaluación para los datos de Validación en el año 2019
...
###### 4.7.1.1. Predicción y evaluación para los datos de entrenamiento
...
###### 4.7.1.2. Predicción y evaluación para los datos de validación en el año 2018
...
###### 4.7.1.3. Predicción y evaluación para los datos de validación en el año 2019
...
### 5.1. Predicción diaria del 2020
...
### 5.2. Predicción diaria del 2021
...
### 5.3. Predicción semanal del 2020
...
### 5.4. Predicción semanal del 2021
...
### 5.5. Predicción mensual del 2020
...
### 5.6. Predicción mensual del 2021
...
## 6. Agrupamiento de los barrios de Medellín de acuerdo a su accidentalidad
...
### 6.1. Mapa de accidentes en la ciudad de Medellín
...
### 6.2. Mapa de agrupamiento según latitud y longitud.
...
### 6.3. Clusterización con número de accidentes por gravedad y barrio.
...
### 6.6. Generación de clusterización, según el k óptimo.
...
#### 6.6.1. Grupo 1 - accidentalidad moderada
...
#### 6.6.2. Grupo 2 - accidentalidad baja
...
#### 6.6.3. Grupo 3 - accidentalidad alta
...
#### 6.6.4. Grupo 4 - accidentalidad media-alta
...
### 6.7. Mapa de accidentalidad en la ciudad de Medellín por agrupamiento
...
*  El modelo lineal generalizado con la familia de distribución Poisson y con la adición de la variable Clase, demostró eficiencia y es un buen candidato para predecir la accidentalidad en Medellín. Con los resultados obtenidos, no se observaron problemas de sobreentrenamiento para este modelo. 
...
*  Con el k óptimo obtenido se puede notar que la agrupación sí representa el nivel de accidentalidad por clusterización en la ciudad de Medellín. Lo cual indica que los cuatro grupos muestran de manera eficiente lo que ocurre en la ciudad, en cuanto a la accidentalidad.
...
*  Sería interesante analizar los datos actuales con una nueva variable que nos indique el estado del clima del día en que ocurrió el accidente. Podríamos definir una variable que puede tener las etiquetas `día soleado` o `día lluvioso`, y de esta forma verificar el comportamiento de los accidentes dependiendo del clima.  

*  Para las predicciones del año 2020, se obtienen resultados por encima de los valores reales, esto es debido a las restricciones de movilidad en el país, por la emergencia sanitaria ocasionada por el COVID-19, más no porque el modelo utilizado no sea eficiente.

*  Las herramientas virtuales que se utilizaron (Google Meet, el software estadístico de R,
R-Studio y WhatsApp, principalmente), así como nuestro compromiso con el proyecto
y nuestros conocimientos en Estadística, hizo posible que desarrolláramos este trabajo
de forma eficaz, a pesar de no estar presentes de forma presencial. Igualmente, el acompañamiento del docente del curso y su disposición a escuchar las dudas en las clases programadas, hizo posible que tuviéramos éxito en esta investigación. 
...
[1]Incidentes viales. (2021). URL: http://medata.gov.co/dataset/incidentes-viales
...
[4]R Markdown Theme Gallery. Andrew Zieffler (2018). URL:https://www.datadreaming.org/post/r-markdown-theme-gallery/


[5] Frequently asked questions. Tal Galili, (2021). URL: https://cran.r-project.org/web/packages/dendextend/vignettes/FAQ.html

[6] ¿Qué significa ss total y entre ss en el agrupamiento k-means? (s.f.) URL:https://qastack.mx/stats/82776/what-does-total-ss-and-between-ss-mean-in-k-means-clustering

[7]Modelos Estadísticos Avanzados. Pedro A. Torres-Saavedra, (2018). URL:https://pegasus.uprm.edu/~pedro.torres/book/

[8]Basic Aesthetics. URL:https://bookdown.org/yih_huynh/Guide-to-R-Book/basic-aesthetics.html
