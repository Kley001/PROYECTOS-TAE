...
#base <- mutate(base, X=str_split(LOCATION, ","))
...
base <- mutate(base, ifelse(nchar(CB)==3,paste0("0", CB),CB),CB)

colnames(base)[21] <- "JCB" #renombrando col 21
colnames(base)

#contar los que tengan 3 digitos y agregarles un cero adelante
...
Ahora se indican las horas pico
...
coercionando los tipos de variables
