...
```{r message=FALSE, warning=FALSE, results = 'hide', echo=F}
#BASE 1
save(datos_1, file = "datos.RData") #rgdata
write.csv(datos_1, "datos.csv")        #csv
...
```{r, include=FALSE}
descriptivo <- read.csv("datos.csv")
```
...
```{r message=FALSE, warning=FALSE, results = 'hide', echo=F }
los_datos <- read.csv("C:/Users/Usuario/Downloads/datos_1.csv", sep=";", encoding="UTF-8")
...
```{r message=FALSE, warning=FALSE, results = 'hide', echo=F }
Base_prediccion <- read.csv("C:/Users/Usuario/Downloads/prediccion_t022_1.csv", sep = ";", encoding = "UTF-8")
...
diario_20_02 <- prediccion_diaria %>%
  ...
  summarise(NRO_TOTAL_VEHICULOS=Nro_Vehiculos)
